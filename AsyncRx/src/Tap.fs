...
module Tap =
    ...
    let tapAsync (onNextAsync: 'a -> Async<unit>) (onErrorAsync: exn -> Async<unit>) (onCompletedAsync: unit -> Async<unit>) : IAsyncObservable<'a> -> IAsyncObservable<'a> =
        let tapAsyncInner (source: IAsyncObservable<'a>) : IAsyncObservable<'a> =
